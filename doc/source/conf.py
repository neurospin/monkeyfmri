...
sys.path.insert(
    0,
    os.path.abspath('{0}/sphinxext/resources'.format(capsul.__path__[0])))
...
html_theme_path = ['{0}/sphinxext/resources/themes/'.format(capsul.__path__[0])]

# The name for this set of Sphinx documents.  If None, it defaults to
# "<project> v<release> documentation".
html_title = 'Monkey MRI'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'MonkeyFMRI'
...
# Remove <process> description from functions
import re
